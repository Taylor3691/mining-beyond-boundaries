...
class ImbalanceHandler:
    def __init__(self, X, y, test_size=0.2, random_state=42):
        """
        Khởi tạo đối tượng ImbalanceHandlerBonus để xử lý mất cân bằng dữ liệu.
        
        Input:
            X: Ma trận đặc trưng (features) của tập dữ liệu.
            y: Vector nhãn (labels) tương ứng.
            test_size: Tỷ lệ tập kiểm thử (mặc định là 0.2).
            random_state: Seed để đảm bảo tính tái lập (mặc định là 42).
    ...
    def run(self):
        """
        Thực hiện kiểm tra, chia tập dữ liệu và đánh giá các chiến lược Resampling.
    ...
    def _analyze(self):
        """
        Phân tích kết quả và hiển thị báo cáo hiệu năng của các chiến lược Resampling.
